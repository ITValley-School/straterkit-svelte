<script>
    ...
    let email = "adminnextjs@gmail.com";
    ...
    const Login = async (e) => {
        ...
        try {
            ...
            console.log(user);
            RouteChange(); // You will need to implement this function in Svelte for routing
        } catch (error) {
            err = error.message;
        }
    };
                ...
                <div class="card-body p-5">
                    ...
                    <div class="row gy-3">
                        <div class="col-xl-12">
                            <label
                                for="signin-username"
                                class="form-label text-default">User Name</label
                            >
                            <input
                                type="text"
                    ...
                    <div class="btn-list text-center">
                        <button class="btn btn-icon btn-light">
                            <i class="ri-facebook-line fw-bold text-dark op-7"
                            ></i>
                        </button>
                        <button class="btn btn-icon btn-light">
                            <i class="ri-google-line fw-bold text-dark op-7"
                            ></i>
                        </button>
                        <button class="btn btn-icon btn-light">
                            <i class="ri-twitter-x-line fw-bold text-dark op-7"
                            ></i>
                        </button>
                    </div>
                </div>
