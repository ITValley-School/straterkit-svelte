            ...
            children: [
              {
                ...
                title: "Subtópico 1",
                children: [
                  { id: 3, title: "Sub-subtópico", children: [] }
                ]
              }
            ]
          },
...
<div class="row mb-4">
  <div class="col-md-4">
    ...
    <select class="form-select" bind:value={livroSelecionado} on:change={() => carregarTopicos(livroSelecionado)}>
    ...
    <Card headerTitle="Editor de Transcrição">
      <span slot="content">
        ...
        <div class="btn-group mb-2">
          <Button text="<b>B</b>" buttontype="button" color="outline-secondary" />
          <Button text="<i>I</i>" buttontype="button" color="outline-secondary" />
          <Button text="<u>U</u>" buttontype="button" color="outline-secondary" />
        </div>
        <textarea rows="6" class="form-control mb-3" placeholder="Digite ou cole sua transcrição aqui..."></textarea>
        <div class="d-flex gap-2 mb-3">
          <Button text="Editar Transcrição" color="outline-primary" />
          <Button text="Improve with IA" color="outline-success" />
        </div>
        <div class="mb-3 border rounded p-3 text-center bg-light" style="border-style: dashed;">
